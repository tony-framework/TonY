...
public final class Utilities {
  ...
  public static Path getRemotePath(THSConfiguration conf, ApplicationId appId, String fileName) {
    String pathSuffix = appId.toString() + "/" + fileName;
    Path remotePath = new Path(conf.get(THSConfiguration.THS_STAGING_DIR, THSConfiguration.DEFAULT_THS_STAGING_DIR),
        pathSuffix);
